...
#define BMA456MM_FIFO_WATERMARK_LEVEL       UINT16_C(650)
 ...
 */
#define BMA456MM_FIFO_ACCEL_FRAME_COUNT     UINT8_C(120)
...
int main(void)
{
     ...
     */
    uint8_t fifo_data[BMA456MM_FIFO_RAW_DATA_USER_LENGTH + BMA4_SENSORTIME_OVERHEAD_BYTE] = { 0 };
    ...
    rslt = bma456mm_map_interrupt(BMA4_INTR1_MAP, BMA4_FIFO_WM_INT, BMA4_ENABLE, &dev);
    bma4_error_codes_print_result("bma4_map_interrupt status", rslt);

    wm_lvl = BMA456MM_FIFO_WATERMARK_LEVEL;
