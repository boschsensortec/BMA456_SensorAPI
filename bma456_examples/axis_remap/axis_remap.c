...
int main(int argc, char *argv[])
{
    ...
    rslt = bma456_init(&bma4);
    bma4_error_codes_print_result("bma456_init", rslt);

    /* Upload the configuration file to enable the features of the sensor. */
    rslt = bma456_write_config_file(&bma4);
    bma4_error_codes_print_result("bma456_write_config", rslt);
    ...
    rslt = bma456_map_interrupt(BMA4_INTR1_MAP, BMA4_DATA_RDY_INT, BMA4_ENABLE, &bma4);
    ...
    rslt = bma456_get_remap_axes(&remap_data, &bma4);
    bma4_error_codes_print_result("bma456_get_remap_axes", rslt);
    ...
    while (1)
    {
        ...
        rslt = bma456_read_int_status(&int_status, &bma4);
    ...
    rslt = bma456_set_remap_axes(&remap_data, &bma4);
    bma4_error_codes_print_result("bma456_set_remap_axes", rslt);
